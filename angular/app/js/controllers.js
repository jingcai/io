...
controller('MyCtrl2', [
    ...
    function($scope, $routeParams, $location) {
        ...
        $scope.headerJson = [
            ...
            ['music', '全觉新人类声频', "地球通往无限自由的生命网格服务器（禹晖心舞888网格）已经开通并可以登陆体验了，<br>不能保证你放弃这里登陆旧地球144网格服务器或者其他星球网格服务器……<br>你的生命你做主！！登陆禹晖心舞888网格的密码是“能使你成为圆觉新人类的十首歌曲的歌词”...... <br><br><a target='_blank' href='http://y.baidu.com/jingcai' class='btn btn-outline-inverse btn-lg'>歌曲下载</a> <a target='_blank' href='http://888000.org/get_files/new.pdf' class='btn btn-outline-inverse btn-lg' >歌词下载</a>"],
            // ['video', '晶彩视频', "开启"],
            ...
            ['events', '公告', '禹晖课程只适合自愿承担人类灵魂成长引航责任的较成熟灵魂， <br>课程期间协助禹晖整合地球华夏人类888新生命完整平衡大宇宙人类数据的银河对接程序， <br>该课程不适合“依赖/恐惧”心频的幼小灵魂与“严重我执”心频的青少年灵魂']
        ];
