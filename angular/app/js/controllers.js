...
controller('MyCtrl2', [
    ...
    function($scope, $routeParams, $location) {
        ...
        $scope.headerJson = [
            ...
            ['music', '全觉新人类声频', "禹晖只能告诉你:地球通往无限自由的生命网格服务器（禹晖心舞888网格）已经开通并可以登陆体验了，不能保证你放弃这里登陆旧地球144网格服务器或者其他星球网格服务器……你的生命你做主！！登陆禹晖心舞888网格的密码是“能使你成为圆觉新人类的十首歌曲的歌词”...... <br><br><a target='_blank' href='http://y.baidu.com/jingcai' class='btn btn-outline-inverse btn-lg'>歌曲下载</a> <a target='_blank' href='/get_files/new.pdf' class='btn btn-outline-inverse btn-lg'>歌词下载</a>"],
            // ['video', '晶彩视频', "开启"],
